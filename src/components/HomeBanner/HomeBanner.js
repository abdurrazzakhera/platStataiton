  ...
  return (
    <div className='grid grid-cols-5 gap-4 '>
      <div className='col-span-3 mt-5'>
        <h2 className='text-5xl font-bold text-sky-600 '>PLAYSTATION 5</h2>
        <h3 className='text-2xl font-semibold mt-2'>PLAY HAS NO LIMITS</h3>
        <p className='text-xl justify-self-center  mx-auto w-9/12 my-4'>
        ...
        <button className='btn-demo  mt-20 absolute'>Live Demo</button>
      </div>
      <div>
        <img
          className='imgSize rounded-md'
